package com.andgdx.util.array;

//import java.lang.reflect.Array;
import java.util.List;

import com.andgdx.util.IMatcher;
import com.andgdx.util.MathUtils;
...
public final class ArrayUtils {
	...
	public static <T> T[] newArray(final Class<T[]> pClass, final int pLength) {
		return pClass.cast(ArrayReflection.newInstance(pClass.getComponentType(), pLength));
	}
