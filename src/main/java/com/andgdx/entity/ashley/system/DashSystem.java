...
public class DashSystem extends AndGDXIteratingSystem implements IEntitySystem{
	...
	private CompMapper<CanDashComponent> canDashMapper = CompMapper.getFor(CanDashComponent.class);
	...
	public DashSystem() {
		super(VelocityComponent.class,AndGDXEntityComponent.class, CanDashComponent.class);
	}
	...
	public void processEntity(ComponentContainer entity, float deltaTime) {
		...
		try
		{
		 if (Gdx.input.isKeyPressed(CanDashComponent.DASH_KEY)) {
