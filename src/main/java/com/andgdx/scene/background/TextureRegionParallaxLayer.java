package com.andgdx.scene.background;

import com.andgdx.scene.background.ParallaxBackgroundUtils.WH;
	...
	public TextureRegionParallaxLayer(TextureRegion texRegion, float oneDimen, Vector2 parallaxScrollRatio, WH wh){
		...
		switch(wh){
		    case width:
		    	...
		    	setRegionHeight(ParallaxBackgroundUtils.calculateOtherDimension(WH.width, oneDimen, this.texRegion));
		    	break;
		    case height:
		    	setRegionHeight(oneDimen);
		    	setRegionWidth(ParallaxBackgroundUtils.calculateOtherDimension(WH.height, oneDimen, this.texRegion));
		    	break;
		}
		setParallaxRatio(parallaxScrollRatio);
	}
