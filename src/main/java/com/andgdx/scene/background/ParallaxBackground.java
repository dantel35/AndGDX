...
import com.andgdx.scene.background.ParallaxLayer.TileMode;
 ...
 *
 */
public class ParallaxBackground implements IParallaxBackground {
	 ...
	 */
	public void draw(Camera pWorldCamera, Batch batch){
		
		OrthographicCamera worldCamera = (OrthographicCamera)pWorldCamera;
