...
public class AndGDXTmxMapLoader extends BaseTmxMapLoader<AndGDXTmxMapLoader.Parameters> {
	 ...
	 * 
	 * @param resolver */
	public AndGDXTmxMapLoader (FileHandleResolver resolver) {
		super(resolver);
	}
	...
	public TiledMap load (String fileName) {
		return load(fileName, new AndGDXTmxMapLoader.Parameters());
	}
	 ...
	 * @return the TiledMap */
	public TiledMap load (String fileName, AndGDXTmxMapLoader.Parameters parameters) {
		try {
...
//				texture.setFilter(parameters.textureMinFilter, parameters.textureMagFilter);
	...
	@Override
	public void loadAsync (AssetManager manager, String fileName, FileHandle tmxFile, AndGDXTmxMapLoader.Parameters parameter) {
		map = null;
	...
	@Override
	public TiledMap loadSync (AssetManager manager, String fileName, FileHandle file, AndGDXTmxMapLoader.Parameters parameter) {
		return map;
	}
