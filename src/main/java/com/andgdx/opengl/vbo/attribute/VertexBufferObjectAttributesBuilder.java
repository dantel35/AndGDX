package com.andgdx.opengl.vbo.attribute;

import com.andgdx.opengl.shader.exception.EngineRuntimeException;
import com.andgdx.util.DataConstants;
...
//		switch (pType) {
//			case Gdx.gl.GL_FLOAT:
//				this.mOffset += pSize * DataConstants.BYTES_PER_FLOAT;
//				break;
//			case Gdx.gl.GL_UNSIGNED_BYTE:
...
//		}
	...
	public VertexBufferObjectAttributes build() {
		if (this.mIndex != this.mVertexBufferObjectAttributes.length) {
			throw new EngineRuntimeException("Not enough " + VertexBufferObjectAttribute.class.getSimpleName() + "s added to this " + this.getClass().getSimpleName() + ".");
		}
